...
SELECT * FROM cars c
ORDER BY c.year_of_issue DESC
OFFSET 5
LIMIT 10;

-- #17 Display cars where car's year of issue not between 1995 and 2005;
SELECT * FROM cars c
WHERE c.year_of_issue NOT BETWEEN 2005 AND 1995;

-- #18 Display most cars in one color
SELECT DISTINCT color, COUNT(*) AS count FROM cars c
GROUP BY color
ORDER BY COUNT(*) DESC ;
